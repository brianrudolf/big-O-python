...
def upper(main_len=100, sub_len=10, num=10000):
    ...
    Python doc description: Return a copy of the string with all
        the cased characters converted to uppercase.
    ...
    def time_upper():
        ...
        timer = timeit.Timer(functools.partial(main_string.upper))
    ...
    time_samples = [time_upper() for i in range(num_random)]
...
if __name__ == "__main__":
    ...
    big_O = [upper(main_len=x, sub_len=x // 10) for x in tqdm(n)]
